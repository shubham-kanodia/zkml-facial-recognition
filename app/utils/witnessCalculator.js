  ...
  const instance = await WebAssembly.instantiate(wasmModule, {
    runtime: {
      exceptionHandler: function (code) {
        ...
        errStr += getMessage();
        // console.log("error was", { errStr });
        throw new Error(errStr);
      },
      showSharedRWMemory: function () {
        printSharedRWMemory();
      },
      printErrorMessage: function (...args) {
        console.log("from printErrorMessage:", { args });
      },
      writeBufferMessage: function (...args) {
        console.log("from writeBufferMessage:", { args });
      },
    },
  });
